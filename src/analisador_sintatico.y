...
atribuicao: variavel T_ATRIBUICAO expressao  //{printf("Atribuição\n");}
...
expressao_simples_2: %empty
    | T_OP_ADD termo expressao_simples_2
...
lista_de_ids: T_ID lista_de_ids_2 //{printf("Lista de ids\n");}

lista_de_ids_2: %empty
    | T_SEPARADOR_INSTRUCAO T_ID lista_de_ids_2
...
variavel: T_ID seletor  //{printf("Variável\n");}
